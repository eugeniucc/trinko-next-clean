...
export const LatestTattooCard = (props: Props) => {
  ...
  return (
    <a className="relative block h-125" href={url} data-pswp-width={1200} data-pswp-height={1600} aria-label={props.alt}>
      <Image className="h-full w-full rounded-md object-cover" src={url} width={450} height={400} alt={props.alt} />
