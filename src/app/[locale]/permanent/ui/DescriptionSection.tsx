      ...
      <div className="container">
        ...
        >
          <div className="flex flex-col gap-10 text-zinc-200">
            <h2 className="bg-linear-to-r from-white to-zinc-300 bg-clip-text text-3xl font-bold text-transparent">{t('title')}</h2>
            <p className="text-lg leading-relaxed">{t('text')}</p>

            <div className="grid grid-cols-1 gap-4 text-left sm:grid-cols-2">
              {cards.map((item, i) => (
                <div key={i} className="rounded-xl bg-linear-to-br from-rose-500/10 to-pink-500/10 p-4 backdrop-blur-sm">
